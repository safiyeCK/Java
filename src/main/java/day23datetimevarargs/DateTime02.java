...
public class DateTime02 { // anlik zamani alma
    public static void main(String[] args) {
        //anlik zamani nasil aliriz?
        LocalTime myCurrentTime= LocalTime.now();
        System.out.println(myCurrentTime); //20:02:10.052384900
        ...
        //gelecek ve gecmis zamana gitme
        LocalTime next=myCurrentTime.plusMinutes(13).plusHours(3).minusMinutes(13).minusHours(3);
        System.out.println(next);

        //Zaman formati nasil degistirilir? datetimeformattir sayesinde tarih ve saat gorunumunu dgeistirebiliyoruz
